...
class LeaveAllRequestsSkeletonLoading extends StatefulWidget {
  const LeaveAllRequestsSkeletonLoading({super.key});

  @override
  State<LeaveAllRequestsSkeletonLoading> createState() =>
      _LeaveAllRequestsSkeletonLoadingState();
}

class _LeaveAllRequestsSkeletonLoadingState
    extends State<LeaveAllRequestsSkeletonLoading>
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: _SkeletonRequestItem(color: animatedColor, opacity: pulse),
            );
          },
        );
      },
