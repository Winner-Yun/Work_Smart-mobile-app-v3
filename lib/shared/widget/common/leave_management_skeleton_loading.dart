...
class LeaveManagementSkeletonLoading extends StatefulWidget {
  const LeaveManagementSkeletonLoading({super.key});

  @override
  State<LeaveManagementSkeletonLoading> createState() =>
      _LeaveManagementSkeletonLoadingState();
}

class _LeaveManagementSkeletonLoadingState
    extends State<LeaveManagementSkeletonLoading>
...
class _SkeletonTimelineItem extends StatelessWidget {
  ...
  const _SkeletonTimelineItem({required this.color, required this.opacity});
