...
const Map<String, String> homeMapStringsEn = {
  ...
  'check_out_deadline_reached': 'Check-out deadline reached',
  'check_in_deadline_reached': 'Check-in deadline reached',
  'deadline_absent_notice':
      'You can\'t scan right now. The system will mark you as absent for today. Come back and scan tomorrow.',
  ...
  'workspace_setup_loading_desc':
      'Loading office location, attendance policy, and today\'s attendance status. Scanning unlocks once this finishes.',
...
const Map<String, String> homeMapStringsKm = {
  ...
  'check_out_deadline_reached': 'ផុតកំណត់ពេលស្កេនចេញ',
  'check_in_deadline_reached': 'ផុតកំណត់ពេលស្កេនចូល',
  'deadline_absent_notice':
      'អ្នកមិនអាចស្កេនបានទេឥឡូវនេះ។ ប្រព័ន្ធនឹងកត់ត្រាអ្នកថាអវត្តមានសម្រាប់ថ្ងៃនេះ។ សូមត្រឡប់មកស្កេនវិញនៅថ្ងៃស្អែក។',
  'ready_to_scan': 'ស្កេន',
  'too_far': 'នៅឆ្ងាយពេក',
  'distance': 'ចម្ងាយ',
  ...
  'workspace_setup_loading_desc':
      'កំពុងផ្ទុកទីតាំងការិយាល័យ គោលការណ៍វត្តមាន និងស្ថានភាពវត្តមានប្រចាំថ្ងៃ។ ការស្កេននឹងអាចប្រើបានពេលរួចរាល់។',
